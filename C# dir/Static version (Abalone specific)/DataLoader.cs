...
namespace Version_1___Abalone_Specific_Code
{
    class DataLoader
    {
        ...
        public DataTable MakeMasterTable()                                //CORRESPONDS TO "x" in pseudo
        {
            ...
            string[] data = System.IO.File.ReadAllLines(@"C:\Users\Andy Rippington\Documents\BSc Data Science and Analytics\Year 3\CE301 - Capstone Project\Source Datasets\Abalone\abalone_training.csv");
        ...
        {
            string[] data = System.IO.File.ReadAllLines(@"C:\Users\Andy Rippington\Documents\BSc Data Science and Analytics\Year 3\CE301 - Capstone Project\Source Datasets\Abalone\abalone_testing.csv");
