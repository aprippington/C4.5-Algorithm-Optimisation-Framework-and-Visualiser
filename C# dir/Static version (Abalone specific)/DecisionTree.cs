...
namespace Version_1___Abalone_Specific_Code
{
    class DecisionTree
    {
        ...
        public Node RunC4_5(DataTable x, List<DataColumn> attributes)    //ID3 / C4.5 ALGORITHM
        {
            ...
            Console.WriteLine("C4.5 Iteration number commencing: " + count);
        ...
        static void Main(string[] args)
        {
            ...
            FileStream filestream = new FileStream("Abalone_Specific_test_log.csv", FileMode.Create);   //Outputs console text to CSV file: "console_data.csv"
            ...
            /*             
            //Try 100 iterations of optimisation cycle
